  ...
  const subPages = [
    {
      ...
      head:
        language === "en"
          ? "Dr. Varsharani Mohite"
          : "सौ. डॉ. वर्षाराणी मोहिते",
      phone: language === "en" ? "+91-8888938583" : "+९१-८८८८९३८५८३",
      icon: FaHeartbeat,
    ...
    },
    {
      ...
      head:
        language === "en" ? "Akshay Subhash Rajmane" : "अक्षय सुभाष राजमाने",
      phone: language === "en" ? "+91-7387579246" : "+९१-७३८७५७९२४६",
      icon: FaSeedling,
