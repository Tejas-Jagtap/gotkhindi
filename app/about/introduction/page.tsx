          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <div className="bg-white rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-3xl sm:text-4xl font-bold text-government-orange mb-2">
                {language === "en" ? "7592" : "७५९२"}
              </h3>
              <p className="text-gray-700 text-sm sm:text-base">
                {t("intro.totalPopulation")}
              </p>
              <p className="text-xs text-gray-500 mt-2">
                {t("intro.males")}: {language === "en" ? "3901" : "३९०१"} |
                {t("intro.females")}: {language === "en" ? "3691" : "३६९१"}
              </p>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-700">
                ...
                <div className="flex justify-between border-b pb-2">
                  ...
                  <span> {language === "en" ? "416301" : "४१६३०१"}</span>
                </div>
              </div>
            </div>
            {/* जमिनीचे वितरण */}
            ...
            <div className="border-l-4 border-red-500 pl-4">
              ...
              <ul className="space-y-1 text-gray-700 text-sm sm:text-base">
                <li>
                  ...
                  {language === "en" ? "100% coverage" : "१००% कव्हरेज"}
                </li>
                <li>
            ...
            <div className="border-l-4 border-purple-500 pl-4">
              ...
              <ul className="space-y-1 text-gray-700 text-sm sm:text-base">
                ...
                <li>
                  ...
                  {language === "en" ? "Transformers: 2" : "ट्रान्सफॉर्मर: 2"}
                </li>
              </ul>
            </div>
            <div className="border-l-4 border-purple-500 pl-4">
